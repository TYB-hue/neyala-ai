...
class BrightDataProxyScraper {
    constructor(location, maxHotels = 10) {
        this.location = location;
        this.maxHotels = maxHotels;
        
        // Bright Data Proxy Configuration
        this.BRIGHTDATA_HOST = 'brd.superproxy.io';
        this.BRIGHTDATA_PORT = '22225';
        this.BRIGHTDATA_USERNAME = 'brd-customer-hl_e7409907-zone-nyala_travel';
        this.BRIGHTDATA_PASSWORD = 'ultcui3jhp91';
    }
        ...
        try {
            ...
            browser = await puppeteer.launch({
                ...
                args: [
                    ...
                    `--proxy-server=${this.BRIGHTDATA_HOST}:${this.BRIGHTDATA_PORT}`
                ]
            });
            ...
            await page.authenticate({
                username: this.BRIGHTDATA_USERNAME,
                password: this.BRIGHTDATA_PASSWORD
            });
            ...
            console.log("Successfully navigated to Booking.com");
            ...
            return hotels.map((hotel, index) => ({
                ...
                source: 'Bright Data Proxy Scraper'
            }));
...
if (require.main === module) {
    ...
    const scraper = new BrightDataProxyScraper(location, maxHotels);
    
    scraper.scrapeHotels().then(hotels => {
        console.log('\nResults saved to: brightdata_proxy_hotels_' + location.replace(/\s+/g, '_') + '.json');
...
module.exports = BrightDataProxyScraper;
