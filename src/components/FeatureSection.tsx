...
export function FeatureSection() {
  const features = [
    ...
    },
    {
      ...
      title: "Create Custom Travel Itineraries in Seconds",
      description: "Our AI travel itinerary generator creates detailed day-by-day plans optimized for your travel style and interests."
    },
    {
    ...
    },
    {
      ...
      description: "The more you use Nyala, the better it gets at recommending places you'll enjoy."
    }
  ]
    ...
    <section className="py-16 bg-white">
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-bold text-gray-800 mb-4">Smart AI Travel Planner & Trip Assistant</h2>
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            Planning your perfect trip has never been easier with our AI travel planner and travel planning app
          </p>
        </div>
        ...
        <div className="mt-16 bg-gradient-to-r from-blue-500 to-purple-600 rounded-2xl p-8 text-white">
          <div className="flex flex-col md:flex-row items-center justify-between">
            <div className="mb-6 md:mb-0 md:mr-8">
              <h3 className="text-2xl font-bold mb-2">The Best AI Tool to Plan a Vacation</h3>
              <p className="text-blue-100">Let our free AI travel planner create a personalized itinerary just for you.</p>
            </div>
            <Link 
              href="/plan"
